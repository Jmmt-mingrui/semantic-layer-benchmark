-- DuckDB TPC-DS SF1 schema.\n-- Derived from the pinned PostgreSQL DDL at commit 63ee7120a89ba5d1c5d8287f98c8e8c427768c98.\n-- Source: https://github.com/litkhai/tpcds-scripts/blob/63ee7120a89ba5d1c5d8287f98c8e8c427768c98/engines/postgres/ddl/schema.sql\n-- The physical column definitions are unchanged because DuckDB accepts these SQL types and constraints.\n\nCREATE SCHEMA IF NOT EXISTS main;\nSET schema = 'main';\n\n--
-- TPC-DS schema — PostgreSQL
--
...
--   * no other change — the column text is already valid PostgreSQL / 그 외 변경 없음
--

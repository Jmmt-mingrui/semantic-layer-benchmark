---
type: Metric Catalog
title: Query-exact Metrics
description: TPC-DS-specific formulas preserved exactly for benchmark fidelity.
resource: urn:tpcds:sf1:metrics:query-exact-metrics
tags:
- tpc-ds-derived
- sf1
- metrics
...
TPC-DS-specific formulas preserved exactly for benchmark fidelity.

---
type: Metric Mapping
title: Question-to-Metric Map
description: Mapping from all 99 canonical questions to metrics and analysis operations.
resource: urn:tpcds:sf1:metrics:question-map
tags:
- tpc-ds-derived
- sf1
- metrics
...
status: draft
sources:
- id: canonical-question-map
  resource: ../../../canonical/tpcds-sf1/question-metric-map.yaml
  title: Canonical question-to-metric mapping
  author: process:semantic-layer-benchmark
---

# Question-to-Metric Map

This concept preserves the complete q01–q99 mapping. Analysis operations remain distinct from reusable metrics, and SQL-aligned overrides are retained.

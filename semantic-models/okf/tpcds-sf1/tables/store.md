...
title: Store
description: Versioned store operations, organization, market, geography, address, time-zone, and tax attributes.
resource: urn:tpcds:sf1:postgresql:public:store
tags: [tpc-ds-derived, sf1, store, dimension]
status: draft

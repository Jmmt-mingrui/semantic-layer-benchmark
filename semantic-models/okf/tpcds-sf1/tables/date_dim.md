...
title: Date
description: Calendar and fiscal attributes used by all sold, shipped, returned, effective, and access date roles.
resource: urn:tpcds:sf1:postgresql:public:date_dim
